...
"void main()\n"
"{\n"
" FragColor = vec4(0.9f, 0.6f, 0.3f, 1.0f);\n" // RGBA: برتقالي
"}\n\0";
...
int main()
{
    ...
    float vertices[] = {
        -0.8f, -0.5f, 0.0f, // يسار أسفل
         0.8f, -0.5f, 0.0f, // يمين أسفل
         -0.8f, 0.5f, 0.8f, //topright
         0.0f,0.5f, -0.8f

    };
    unsigned int indices[] = {
    0, 1, 2, // downLeft_downRight_topLeft
    2, 3, 1, // topLeft_topRight_downRight
    };
    // --- 7. إعداد VBO و VAO ---
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0); // glBindVertexArray(0); // لا داعي لفك الربط في كل فريم
